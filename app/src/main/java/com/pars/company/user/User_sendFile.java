...
public class User_sendFile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView_user =(RecyclerView)findViewById(R.id.recyclerview_sendfile_user);
        adapter_user = new HistoryRecyclerAdapter(User_sendFile.this, itemList_user);
        LinearLayoutManager mLayoutManager = new LinearLayoutManager(User_sendFile.this);
