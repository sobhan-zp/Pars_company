...
public class ReceiveRecyclerAdapter extends RecyclerView.Adapter<ReceiveRecyclerAdapter.MyViewHolder> {
    ...
    public ReceiveRecyclerAdapter(Context context, List<History> itemList) {
