...
public class FragmentSendFile extends Fragment {
    ...
    public static FragmentSendFile newInstance() {

        Bundle args = new Bundle();
        FragmentSendFile fragment = new FragmentSendFile();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_sendfile, container, false);
        ...
        btnNextSendFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Log.e("TAG", save.load(AppController.SAVE_USER_ID_FOR_SENDFILE, "0"));

                if (save.load(AppController.SAVE_USER_ID_FOR_SENDFILE, "0").equals("0")) {

                    Toast.makeText(getActivity(), "لطفا کاربری انتخاب کنید", Toast.LENGTH_SHORT).show();
