...
/**
 * Created by saeed on 10/26/2016.
 */
public class FragmenHistory extends Fragment {
    ...
    public static FragmenHistory newInstance() {
        ...
        FragmenHistory fragment = new FragmenHistory();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter_user = new HistoryRecyclerAdapter(getActivity(), itemList_user);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                if (save.load(AppController.SAVE_USER_IS_ADMIN, "0").equals("1")) {
